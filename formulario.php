...
if(isset($_POST['submit']))
{
    ...
    $result = mysqli_query($conexao, "INSERT INTO usuarios (nome, email, telefone, sexo, data_nasc, cidade, estado) VALUES ('$nome','$email','$telefone','$genero','$data_nasc','$cidade','$estado')");
